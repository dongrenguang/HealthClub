...
public class RegisterAction extends BaseAction {
	...
	public String execute() throws Exception {
        ...
        if(reg_pictureFileName!=null && reg_picture!=null){
        	picture=Assist.savePicture(savePath, reg_username, reg_pictureFileName, reg_picture);
        }
        java.sql.Date birthday=Assist.getBirthday(reg_birthday); 
        int id=userService.add(reg_username, reg_password, reg_email, reg_gender, birthday, reg_address, picture, reg_type, register_time, state);
