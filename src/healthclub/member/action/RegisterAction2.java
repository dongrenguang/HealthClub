...
public class RegisterAction2 extends BaseAction{
	...
	public String execute(){
        ...
        if(reg_picture2FileName!=null && reg_picture2!=null){
        	picture=Assist.savePicture(savePath, reg_username2, reg_picture2FileName, reg_picture2);
        }
        
        int id=userService.add(reg_username2, reg_password2, reg_email2, "0", register_time, reg_address2, picture, reg_type2, register_time, state);
        if(id<0){
        	return "Error";
        }
