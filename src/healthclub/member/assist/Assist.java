...
//			e.printStackTrace();
    ...
    public static String getPictureType(String picName){//�ָ��ַ��õ�ͼƬ�ĸ�ʽ�����硰.png��
...
//    }
    ...
    public static String getNowDateTime(){
		...
		String nowDateTime=df.format(new Date());// new Date()Ϊ��ȡ��ǰϵͳʱ��
		return nowDateTime;
    }
    ...
    public static String getCurrentMonthDay(String time){
		...
		int current_year = c.get(Calendar.YEAR);    //��ȡ��
		int current_month = c.get(Calendar.MONTH) + 1;   //��ȡ�·ݣ�0��ʾ1�·�
